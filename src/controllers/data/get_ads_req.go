...
type GetAdsReq struct {
	...
	Gender   enum.Gender      `form:"gender" validate:"omitempty" binding:"required,enum"`
	Country  enum.CountryCode `form:"country" validate:"omitempty" binding:"required,enum"`
	Platform enum.Platform    `form:"platform" validate:"omitempty" binding:"required,enum"`
}
